...
() {
  ...
  typeset -g POWERLEVEL9K_RULER_FOREGROUND=$NORD1
  ...
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=$NORD15
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS}_FOREGROUND=$NORD14
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=$NORD8
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=$NORD8
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=$NORD10
  ...
  typeset -g POWERLEVEL9K_VCS_LOADING_FOREGROUND=$NORD1
  ...
  typeset -g POWERLEVEL9K_VCS_{CLEAN,MODIFIED,UNTRACKED}_FOREGROUND=$NORD14
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=$NORD7
